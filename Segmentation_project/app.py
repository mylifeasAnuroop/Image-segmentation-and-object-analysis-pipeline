...
if uploaded_files:
    ...
    for uploaded_file in uploaded_files:
        ...
        # Display the uploaded image with the heading "Master Image"
        st.header("Master Image")
        st.image(uploaded_file, use_column_width=True)
        
        # Remove or comment out the caption if you don't want to display the image name
...
if uploaded_files:
    ...
    for uploaded_file in uploaded_files:
        ...
        # Display the uploaded image with a bold caption
        st.image(uploaded_file, use_column_width=True)
        st.markdown("**Master Image**")
